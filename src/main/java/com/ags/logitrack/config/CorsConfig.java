...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        // Desativa o uso de credenciais (config.setAllowCredentials(false)) e libera acesso para todas as origens usando config.addAllowedOriginPattern("*"), facilitando testes em ambiente de desenvolvimento.
